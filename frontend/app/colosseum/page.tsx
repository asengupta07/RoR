...
export default function GladiatorBattle() {
  ...
  const [playerGladiatorId, setPlayerGladiatorId] = useState<number | null>(null)
  ...
  useEffect(() => {
    const updateRewards = async () => {
      if (showRewards) {
        console.log("Sending rewards to API with...", rewards, address, playerGladiatorId, playerCharacter)
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 p-8 text-center">
              ...
              <button
                onClick={resetGame}
                className={`px-8 py-3 rounded-lg text-lg font-bold transition-all duration-300 ${isPlayerWinner ? "bg-amber-500 hover:bg-amber-600 text-black" : "bg-red-600 hover:bg-red-700 text-white"
                  }`}
              >
                Return to the Ludus
              </button>
